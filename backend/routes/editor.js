...
async function onRuntimeInitialized(){
    ...
    router.get('', function(req, res) {
        jimp.read('./no_image.jpg').then(
            (jimpSrc) => { jimpSrc.write('output.png') }
        )
    ...
    async function zoom(image, zoomRate, newName) {
        // TODO OpenCV.js で処理
        ...
        const jimpSrc = await jimp.read( './no_image.jpg' )
        jimpSrc.write('output.jpg')
